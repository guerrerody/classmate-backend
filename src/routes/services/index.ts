...
router.get("/get-postComment", getCommentValidator, handleErrors, getCommentByPost);
router.get("/followed-posts", getPostsValidator, handleErrors, getPostByFollowing);
